...
const routes = [
  ...
  { source: "umzug-neckarstadt.html", route: "umzug-neckarstadt" },
  { source: "umzugsfirma-heidelberg.html", route: "umzug-heidelberg" },
  { source: "umzugsfirma-ludwigshafen.html", route: "umzugsfirma-ludwigshafen" },
  { source: "umzugsfirma-schwetzingen.html", route: "umzugsfirma-schwetzingen" },
  { source: "umzugsfirma-viernheim.html", route: "umzugsfirma-viernheim" },
  { source: "umzug-frankfurt-sachsenhausen.html", route: "umzug-frankfurt-sachsenhausen" },
  { source: "umzug-frankfurt-westend-bockenheim.html", route: "umzug-frankfurt-westend-bockenheim" },
  { source: "umzug-frankfurt-nordend-bornheim.html", route: "umzug-frankfurt-nordend-bornheim" },
  { source: "umzugsfirma-weinheim.html", route: "umzugsfirma-weinheim" },
  { source: "umzugsfirma-bergstrasse-bensheim-heppenheim.html", route: "umzugsfirma-bergstrasse-bensheim-heppenheim" },
  { source: "umzugsfirma-darmstadt.html", route: "umzugsfirma-darmstadt" },
  { source: "bueroumzug-frankfurt.html", route: "bueroumzug-frankfurt" },
  { source: "umzug-frankfurt-gallus-europaviertel.html", route: "umzug-frankfurt-gallus-europaviertel" },
  { source: "seniorenumzug-frankfurt.html", route: "seniorenumzug-frankfurt" },
  { source: "umzug-mannheim-kaefertal.html", route: "umzug-mannheim-kaefertal" },
  { source: "umzug-mannheim-feudenheim.html", route: "umzug-mannheim-feudenheim" },
  { source: "umzug-mannheim-rheinau-seckenheim.html", route: "umzug-mannheim-rheinau-seckenheim" },
  { source: "umzug-mannheim-waldhof-sandhofen.html", route: "umzug-mannheim-waldhof-sandhofen" },
  { source: "bueroumzug-mannheim.html", route: "bueroumzug-mannheim" },
  { source: "seniorenumzug-mannheim.html", route: "seniorenumzug-mannheim" },
